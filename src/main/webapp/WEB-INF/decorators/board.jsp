	...
	$(document).ready(function()
			{	
			    ...
			    $('#selOne').change(function(){
			    	$('#selTwo option').remove();
			    	var i = $('#selOne option').index($('#selOne option:selected'))-1;
			    	$("#selTwo").append("<option>동 선택</option>");
					for(var s=0; s<listValue[i].length; s++){
						$("#selTwo").append("<option value="+listValue[i][s]+">"+listValue[i][s]+"</option>");
					}
					$('#selTwo').selectpicker('refresh');
			    });
			});
	function openWin(){
...
<div id="wrapper">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="http://localhost:8080/sport">ABCD</a>
			</div>
        ...
        <a onclick="javascript:openWin();" id="addClass" href="#"><span class="glyphicon glyphicon-comment"></span> Teamchat </a>
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								...
								<li class="divider"></li>
								<li><a href="/sport/logout"><i class="fa fa-fw fa-power-off"></i>
										Log Out</a></li>
							</ul></li>
					</ul>
				</c:if>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="http://localhost:8080/sport/notice?p=1"><i class="fa fa-fw fa-edit"></i> 공지사항</a>
                    </li>
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#mypage"><i class="fa fa-fw fa-bar-chart-o"></i> 마이페이지<i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="mypage" class="collapse">
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#match"><i class="fa fa-fw fa-table"></i> 매치보드<i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="match" class="collapse">
                            <li>
                                <a href="http://localhost:8080/sport/team/match">매치신청</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#comm"><i class="fa fa-fw fa-edit"></i> 커뮤니티<i class="fa fa-fw fa-caret-down"></i></a>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3><span class="glyphicon glyphicon-user"></span> 로그인</h3>
      </div>
      <div class="modal-body">
        <form role="form" action="/sport/login" method="post">
...
<div class="modal fade" id="signUp" role="dialog">
  <div class="modal-dialog">
    <!-- Modal content-->
    <div class="modal-content">
        <form role="form" method="post" id="registerForm" action="/sport" enctype="multipart/form-data" class="form-horizontal">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h3><span class="glyphicon glyphicon-pencil"></span> 회원가입</h3>
      </div>
      <div class="modal-body">
          <div class="form-group">
